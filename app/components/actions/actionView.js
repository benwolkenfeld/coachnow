...
actionView.controller('actionCtrl', function($scope, $filter, ActionService) {
  ...
  actionView.controller('taskActionModalCtrl', function ($scope, $modal, $log, ActionService) {
  ...
  actionView.controller('ModalInstanceCtrl', function ($scope, $modalInstance, selectedForm, task, ActionService, $filter) {
  ...
  //
  actionView.directive('datepickerPopup', function (dateFilter, datepickerPopupConfig) {
    return {
      restrict: 'A',
      priority: 1,
      require: 'ngModel',
